...
```bash
git clone https://github.com/example-org/fleetmate-macintosh.git
...
fleetmate snipe asset ASSET-000
...
```bash
# Search assets
fleetmate tdx assets --search ASSET-000 --limit 10
...
# Retrieve Munki logs
fleetmate ssh logs ASSET-000 --lines 50

# Run Munki commands
fleetmate ssh munki check ASSET-000
...
Proprietary - Example Organisation
