...
Should show AD TGT ticket with UPN (e.g., `rchristiansen@ECUAD.CA`). If empty, user may need to sign out and back in to macOS to establish Platform SSO credentials.
